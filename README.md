...
* **Indicateur :** La taille du centroïde est **proportionnelle au nombre de communes du département** ayant mis en place un Plan de Prévention des Risques (PPR ou PPRT) ou le nombre de sites/arrêtés.
...
Les données sont issues de sources officielles (Sisfrance, ARIA, Géorisques, IRSN etc...) et traitées pour garantir une précision géographique optimale :
